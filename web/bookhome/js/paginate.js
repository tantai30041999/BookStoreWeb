    ...
    $.fn.paginate = function( options ) {
        ...
        function createPaginationControls( pages ) {
            ...
            if ( options.prev_next == true ) {
                obj.find( "." + options.pagination_class ).append( '<li class="prev"><a href="#items">' + options.prev_text + '</a></li>' );
            }
            ...
            // Add Next Button
            if ( options.prev_next == true ) {
                obj.find( "." + options.pagination_class ).append( '<li class="next"><a href="#items">' + options.next_text + '</a></li>' );
            }
        }
